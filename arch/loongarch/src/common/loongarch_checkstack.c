...
size_t loongarch_stack_check(uintptr_t alloc, size_t size)
{
   ...
   * stack memory allocation and search to higher addresses.  The first
   * word we encounter that does not have the magic value is the high
   * water mark.
   */
