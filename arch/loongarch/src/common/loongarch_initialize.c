...
void up_initialize(void)
{
  ...
  /* Initialize the DMA subsystem if the weak function
   * loongarch_dma_initialize has been brought into the build
   */
...
#ifdef CONFIG_HAVE_WEAKFUNCTIONS
  if (loongarch_soc_initialize)
#endif
    {
      loongarch_soc_initialize();
    }
