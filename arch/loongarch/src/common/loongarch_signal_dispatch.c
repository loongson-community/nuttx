 ...
 *   arch/loongarch/src/common/loongarch_signal_handler.S.  This function
 *   is the user-space, signal handler trampoline function.  It is called
 *   from up_signal_dispatch() in user-mode.
 *
 * Input Parameters:
