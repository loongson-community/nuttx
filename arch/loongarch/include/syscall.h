...
/* Loongarch system calls ***************************************************/

/* SYS call 1 and 2 are defined for internal use by the Loongarch port (see
 * arch/loongarch/include/syscall.h). In addition, SYS call 3 is the
...
/* SYS call 1:
 *
 * void loongarch_fullcontextrestore() noreturn_function;
 */
